...
class Animation_Example2(MovingCameraScene):
    def construct(self):
        ...
        self.wait(0.2)
        self.play(Create(amp), run_time=0.5)
        self.wait(0.2)
        self.play(Create(conn5), run_time=0.5)
        self.wait(0.2)
        self.play(Create(act), run_time=0.5)
        self.wait(0.2)
        self.play(Create(conn6), run_time=0.5)
        self.wait(0.2)
        self.play(Create(mech), run_time=0.5)
        self.wait(0.2)
        self.play(Create(output), Create(conn7), run_time=0.5)
        self.wait(0.2)
        self.play(Create(sens), run_time=0.5)
        self.wait(0.2)
        self.play(Create(feedback), Create(surrounding2), Write(righttext), run_time=0.5)
        self.wait(0.2)
