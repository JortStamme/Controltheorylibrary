...
class pzmapcontinuous(Scene):
    def construct(self):
        ...
        num2 = s-1
        den2 = (s+3)*(s-2)
        pzmap1 = PoleZeroMap(num1,den1, x_range=[-4,3,1], y_range=[-3,3,1])
        pzmap2 = PoleZeroMap(num2,den2, x_range=[-4,3,1], y_range=[-3,3,1])
        ...
        self.play(Create(pzmap1.surrbox), Create(pzmap1.y_ticks), Create(pzmap1.x_ticks))
        self.wait(0.5)
        ...
        self.wait(0.3)
        self.play(Write(pzmap1.text_stable), Write(pzmap1.text_unstable))
        self.wait(0.5)
        self.play(Write(pzmap1.title_text))
        self.wait(1.2)
        self.play(Create(pzmap1.zeros), Create(pzmap1.poles))
        self.wait(2)
        self.play(FadeOut(pzmap1.title_text), Write(pzmap2.title_text))
        self.wait(1)
