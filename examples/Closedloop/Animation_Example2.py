...
class Animation_Example2(MovingCameraScene):
    def construct(self):
        ...
        self.wait(0.5)
        self.play(Create(feedforward),Create(conn1), Create(sum1), Create(conn2))
        self.wait(0.5)
        self.play(Create(ffcontroller), Create(fbcontroller))
        self.wait(0.5)
        self.play(Create(feedforward2), Create(conn3))
        self.wait(0.5)
        self.play(Create(sum2))
        self.wait(0.5)
        self.play(Create(conn4), Create(surrounding1), Write(lefttext))
        self.wait(0.2)
        self.play(Create(amp))
        self.wait(0.2)
        ...
        self.wait(0.2)
        self.play(Create(mech))
        self.wait(0.2)
        self.play(Create(output), Create(conn7))
        self.wait(0.3)
        self.play(Create(sens))
        self.wait(0.2)
        self.play(Create(feedback), Create(surrounding2), Write(righttext))
        self.wait(0.5)
