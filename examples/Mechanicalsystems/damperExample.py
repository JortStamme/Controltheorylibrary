...
class DamperExample(Scene):
    def construct(self):
        ...
        # Step 1: Basic damper
        damper1 = control.damper(start=2*DOWN, end=UP)
        ...
        damper2 = control.damper(start=2*DOWN, end=UP, width=1.0)
        ...
        damper3 = control.damper(start=2*DOWN, end=UP, width=1.0, box_height=1.0)
        ...
        damper4 = control.damper(start=LEFT*2+DOWN, end=RIGHT+UP, width=1.0, box_height=1.0)
